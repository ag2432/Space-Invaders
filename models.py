...
class Bolt(GRectangle):
    ...
    # Attribute _bolttype: the type of bolt
    # Invariant: _bolttype is either 'alien' or 'ship'

    def getVelocity(self):
        """
        GETTER that RETURNS the value of the bolt velocity.
        """
        return self._velocity

    def getBolttype(self):
        """
        GETTER that RETURNS the bolt type.
        """
        return self._bolttype

    def __init__ (self,x,y,velocity, bolttype):
        """
        Initializes the Bolt class.
        """
        super().__init__(x=x, y=y, width= BOLT_WIDTH, height= BOLT_HEIGHT, fillcolor='black', linecolor='black')
        self._velocity= velocity
        self._bolttype= bolttype
